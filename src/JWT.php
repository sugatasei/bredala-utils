...
class JWT
{
    ...
    public static function decode($jwt, $key)
    {
        ...
        if (empty($key)) {
            throw new JWTException("Key may not be empty");
        }
        ...
        if (isset($payload->nbf) && $payload->nbf > ($timestamp + static::$leeway)) {
            throw new JWTException('Cannot handle token prior to ' . date('c', $payload->nbf));
        }
        ...
        if (isset($payload->iat) && $payload->iat > ($timestamp + static::$leeway)) {
            throw new JWTException('Cannot handle token prior to ' . date('c', $payload->iat));
        }
